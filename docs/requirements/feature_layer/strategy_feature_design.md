...
1d 大结构用于表达大级别支撑压力和主要区间，4h 小结构用于表达大区间内部更细的短周期位置。FeatureLayer 不得把两者强行合并成一个支撑压力答案。

### 10.2 P0 候选特征

| 特征类型 | 业务含义 | 示例 FeatureCode | 服务的原子信号 |
|---|---|---|---|
| 1d 大结构支撑区 | 大级别支撑价格带 | structure_major_support_lower_1d_365 / structure_major_support_upper_1d_365 | 靠近大支撑、跌破大支撑 |
| 1d 大结构压力区 | 大级别压力价格带 | structure_major_resistance_lower_1d_365 / structure_major_resistance_upper_1d_365 | 靠近大压力、突破大压力 |
| 4h 小结构支撑区 | 短周期细支撑价格带 | structure_minor_support_lower_4h_120 / structure_minor_support_upper_4h_120 | 靠近小支撑、跌破小支撑 |
| 4h 小结构压力区 | 短周期细压力价格带 | structure_minor_resistance_lower_4h_120 / structure_minor_resistance_upper_4h_120 | 靠近小压力、突破小压力 |
| 距离支撑百分比 | 当前价格距离支撑区的百分比 | structure_major_distance_to_support_upper_pct_1d_365 / structure_minor_distance_to_support_upper_pct_4h_120 | 当前靠近支撑区 |
| 距离压力百分比 | 当前价格距离压力区的百分比 | structure_major_distance_to_resistance_lower_pct_1d_365 / structure_minor_distance_to_resistance_lower_pct_4h_120 | 当前靠近压力区 |
| 区间位置百分比 | 当前价格在结构区间中的位置 | structure_major_range_position_pct_1d_365 / structure_minor_range_position_pct_4h_120 | 区间中部 / 靠近边界 |
| 区间宽度百分比 | 支撑压力区间相对宽度 | structure_major_range_width_pct_1d_365 / structure_minor_range_width_pct_4h_120 | 区间宽度判断 |
| 支撑触碰次数 | 价格测试支撑区次数 | structure_major_support_touch_count_1d_365 / structure_minor_support_touch_count_4h_120 | 支撑区多次有效 |
| 压力触碰次数 | 价格测试压力区次数 | structure_major_resistance_touch_count_1d_365 / structure_minor_resistance_touch_count_4h_120 | 压力区多次有效 |
| 突破幅度 | 收盘价突破压力区的距离 | structure_major_breakout_above_resistance_pct_1d_365 / structure_minor_breakout_above_resistance_pct_4h_120 | 向上突破压力区 |
| 跌破幅度 | 收盘价跌破支撑区的距离 | structure_major_breakdown_below_support_pct_1d_365 / structure_minor_breakdown_below_support_pct_4h_120 | 向下跌破支撑区 |
...
structure 的具体 P0 算法以 `docs/requirements/feature_layer/structure_features.md` 为准。
...
risk_state 可以复用 K 线振幅、ATR 分位、实体比例和影线比例等中性特征作为证据，但输出语义必须服务于“信号可靠性风险、方向暴露风险、追单风险或市场扰动风险”，不得重复输出“高波动 / 低波动”这类 volatility 结论。

risk_state 特征不得表达“风险高所以不操作”。如果系统已有仓位，不操作本身也可能是风险暴露；具体目标仓位和动作由后续 StrategySignal / DecisionSnapshot / 订单链路处理。
...
risk_state 的具体 P0 特征目录以 `docs/requirements/feature_layer/risk_state_features.md` 为准。
