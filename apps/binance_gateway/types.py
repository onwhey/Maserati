...
ERROR_ORDER_CANCEL_DISABLED = "order_cancel_disabled"
ERROR_ORDER_STATUS_QUERY_DISABLED = "order_status_query_disabled"
ERROR_FILL_QUERY_DISABLED = "fill_query_disabled"
