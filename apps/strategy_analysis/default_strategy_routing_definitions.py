...
DEFAULT_STRATEGY_ROUTE_RULES: tuple[StrategyRouteRuleTemplate, ...] = (
    ...
    StrategyRouteRuleTemplate(
        ...
        display_name="顶部反转候选选择标准趋势不交易策略",
        description="顶部反转候选环境下，选择标准趋势模板的顶部反转未确认不交易策略。",
        priority=90,
        action=StrategyRouteAction.SELECT_STRATEGY,
    ...
    StrategyRouteRuleTemplate(
        ...
        display_name="底部反转候选选择标准趋势不交易策略",
        description="底部反转候选环境下，选择标准趋势模板的底部反转未确认不交易策略。",
        priority=100,
        action=StrategyRouteAction.SELECT_STRATEGY,
    ...
    StrategyRouteRuleTemplate(
        ...
        display_name="无方向区间选择标准趋势不交易策略",
        description="无方向震荡环境下，选择标准趋势模板的无方向区间不交易策略。",
        priority=110,
        action=StrategyRouteAction.SELECT_STRATEGY,
    ...
    StrategyRouteRuleTemplate(
        ...
        display_name="高风险环境选择标准趋势不交易策略",
        description="高风险环境下，选择标准趋势模板的高风险环境不交易策略。",
        priority=120,
        action=StrategyRouteAction.SELECT_STRATEGY,
    ...
    StrategyRouteRuleTemplate(
        ...
        display_name="不明确环境选择标准趋势不交易策略",
        description="市场环境不明确时，选择标准趋势模板的不明确环境不交易策略。",
        priority=130,
        action=StrategyRouteAction.SELECT_STRATEGY,
