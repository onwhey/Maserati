...
BINANCE_ORDER_CANCEL_ENABLED = env_bool("BINANCE_ORDER_CANCEL_ENABLED", default=False)
...
ORDER_PLAN_SUPPORTED_ORDER_TYPES = csv_env("ORDER_PLAN_SUPPORTED_ORDER_TYPES", default=["MARKET", "LIMIT"])
...
REVIEW_DATASET_SCHEMA_VERSION = env_str("REVIEW_DATASET_SCHEMA_VERSION", default="1.0")
REVIEW_DATASET_ALLOWED_EXPORT_FORMATS = csv_env("REVIEW_DATASET_ALLOWED_EXPORT_FORMATS", default=["json", "jsonl"])
REVIEW_DATASET_MAX_PERIODS_PER_EXPORT = env_int("REVIEW_DATASET_MAX_PERIODS_PER_EXPORT", default=100)
REVIEW_DATASET_EXPORT_DIR = env_str("REVIEW_DATASET_EXPORT_DIR", default="review_exports")
